...
weapon_repertory = {
    ...
    "Hammer":
        {"name": "Hammer",
         "class": "Blunt",
         "sprite": "Sprites/Weapon/Hammer.png",
         "gunshot sound": "Blunt",
         "reloading sound": "Reload Enemy 1",
         "jamming sound": "Jamming",
         "sound level": 0,
    ...
    "Sickle":
        {"name": "Sickle",
         "class": "Slash",
         "sprite": "Sprites/Weapon/Enemy Weapons/Sickle.png",
         "gunshot sound": "Slash",
         "reloading sound": "Silence",
         "jamming sound": "Silence",
         "sound level": 0,
         ...
         "bullets per shot": 1,
         "ammo cost": 0,
         "bullet info": [5, 2, 35, 16, {"Counter not allowed": True}],
         "max ammo": 1,
         "ammo pool": 0,
         "crit rate": 0.1,
         "crit multiplier": 2,
         ...
         "alt fire": "none",
         "passive": "none"},
    "Enemy Soviet Rifle":  # Based on the player weapon of the same name
        {"name": "Soviet Rifle",
         "class": "Semi-auto",
         "sprite": "Sprites/Weapon/Soviet Rifle.png",
         "gunshot sound": "Small arms",
         "reloading sound": "Reload Enemy 1",
         "jamming sound": "Reload Enemy 1",
         "sound level": 0,
         ...
         "bullets per shot": 1,
         "ammo cost": 1,
         "bullet info": [5, 50, 4, 3, {"Piercing": False, "Smoke": False}],
         "max ammo": 30,
         "ammo pool": 750,
         "crit rate": 0.025,
         "crit multiplier": 2,
         ...
         "alt fire": "none",
         "passive": "none"},
    "Enemy Molotov":  # Based on the player weapon of the same name
        {"name": "Enemy Molotov",
         "class": "Semi-auto",
         "sprite": "Sprites/Weapon/Enemy Weapons/CommieBot Flamethrower.png",
         "gunshot sound": "Fire",
         "reloading sound": "Reload Enemy 1",
         "jamming sound": "Jamming",
         "sound level": 0,
         ...
         "bullets per shot": 2,
         "ammo cost": 1,
         "bullet info": [3, 90, 3, 2, {"Particle allowed": False,
                                       "Burn chance": 0.125,
                                       "Burn duration": 30,
                                       "Colour": Fun.RED}],
         "max ammo": 20,
