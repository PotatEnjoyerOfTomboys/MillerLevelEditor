...
def main_loop_no_party(WIN, CLOCK, entities, level, scrolling, scrolling_target_entities, end_with_main_player=True):
    Fun.stop_music()
    gaming = True
    time_passed = 0
    main_player = Event.ENEMY_NO_OWNER
    ...
    while gaming:
        ...
        CLOCK.tick(60)
    Fun.stop_music()
    return end_status, mission_end_screen, big_game_loop, time_passed
